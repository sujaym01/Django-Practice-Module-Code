            ...
            try:    
                ...
                if current_user.balance >= amount:
                    if amount >= min_balance_to_transfer and amount <= max_balance_to_transfer:
                        ...
                        # sent mail to the current user with transfer money sms
                        send_transaction_email(
                            # self.request.user,
                            current_user.user, 
                            amount, 
                            "Transfered Money SMS", 
                        ...
                        # sent mail to the recever with receive  money sms
                        send_transaction_email(
                            to_user.user, 
                            amount, 
                            "Received Money", 
                            "transactions/receive_money_email.html",
                        )               
                    else:
                        messages.error(
                        request,
